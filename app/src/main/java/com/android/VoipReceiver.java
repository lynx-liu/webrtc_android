...
import com.android.core.util.ActivityStackManager;
import com.android.core.util.Utils;
import com.android.core.voip.AsyncPlayer;
...
public class VoipReceiver extends BroadcastReceiver {
    ...
    public static String ACTION_VOIP_RECEIVER = "com.android.webrtc.voip.Receiver";
    ...
    private void onBackgroundHasPermission(
            ...
            String inviteId, Boolean audioOnly, String inviteUserName) {
        if (gEngineKit.startInCall(App.getInstance(), room, inviteId, audioOnly)) {
    ...
    private void onHasPermission(Context context, String room, ArrayList<String> list,
                                 String inviteId, Boolean audioOnly, String inviteUserName) {
        if (gEngineKit.startInCall(App.getInstance(), room, inviteId, audioOnly)) {
            App.getInstance().setOtherUserId(inviteId);
    ...
    private void onPermissionDenied(String room, String inviteId) {
        gEngineKit.sendRefuseOnPermissionDenied(room, inviteId);//通知对方结束
